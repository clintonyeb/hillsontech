...
exports.login = function (request: any, reply: any) {
...
exports.logout = function (request: any, reply: any) {
    request.cookieAuth.clear();
    return reply.redirect('/');
}

exports.registerUser = function applyUser(request: any, reply: any) {
...
function loginUser(request: any, reply: any) {
...
exports.products = function (request: any, reply: any) {
    return successReply(reply, 'products', null);
}

exports.contacts = function (request: any, reply: any) {
...
exports.recoverPassword = function (request: any, reply: any) {
    return successReply(reply, 'recover-pass', null);
}

exports.createNewPassword = function (request: any, reply: any) {
    const mailer = request.server.app.mailer;
    const db = request.server.app.db;
    let data = Hoek.clone(request.payload);
...
function successReply(reply, view, data, message ? : string) {
...
function errorReply(reply: Object, view: string, data: Object, message: string = "Internal server error") {
    return reply.view(view, {
        response: {
            error: {
                message: message
